...
class Main {
   ...
   *
   * @return двумерный массив, длина которого и каждый элемент сгенерирован случайным образом
   */
   ...
   *
   * @return двумерный массив, где каждый элемент введен пользователем с учетом ошибок
   */
  ...
  /**
   * метод, принимающий исходный двумерный массив для замены строки и столбца в этом же массиве
   *
   * @param ar - двумерный массив, над которым будут производиться действия замены
   */
   ...
   *
   * @param ar - двумерный итоговый массив
   */
